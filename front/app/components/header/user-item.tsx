        ...
        <>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <div className="flex ml-0. bg-transparent hover:bg-neutral-950/5 transition-colors duration-300 p-1 rounded-lg border-none items-center w-fit gap-2">
                        ...
                        {user ? (
                            ...
                            <div className="text-xs text-[#868E96]">Carregando...</div>
                        )}
                    </div>
                </DropdownMenuTrigger>
